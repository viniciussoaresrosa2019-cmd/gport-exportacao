-- Use este arquivo quando o Supabase informar que "users" já existe,
-- mas tabelas como "processes" ainda não existem.
-- Ele preserva os usuários atuais e cria somente o que estiver faltando.
...
CREATE TABLE IF NOT EXISTS users (
  ...
  role VARCHAR(20) NOT NULL DEFAULT 'analyst' CHECK (role IN ('admin', 'analyst', 'vgm', 'financeiro')),
